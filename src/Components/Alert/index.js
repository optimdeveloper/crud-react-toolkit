...
export default function Alert({ type, message }) {
  ...
  return (
    ...
    <button onClick={()=>dispatch({ type: "LOGIN_CLOSE_ERROR" })} type="button" className="ml-auto -mx-1.5 -my-1.5 bg-green-100 text-green-500 rounded-lg focus:ring-2 focus:ring-green-400 p-1.5 hover:bg-green-200 inline-flex h-8 w-8 dark:bg-green-200 dark:text-green-600 dark:hover:bg-green-300" data-dismiss-target="#alert-3" aria-label="Close">
